import { DurationUnit, DurationValue, JobLevel, JobRole, JobType, SalaryType, StatusType, Vacancies } from "@/types";
...
export const jobProfile = pgTable("job_posting", {
  ...
  salary: doublePrecision("salary").notNull().default(0.0),
